...
<body>
    ...
    <?php
        ...
        $sql="INSERT INTO Orders (Phone, Items, Note, [Address], OrderTime) VALUES (?, ?, ?, ?, ?)";
        $params = array($Phone, $Items, $Note, $Address, $OrderTime);
        $stmt = sqlsrv_query($conn, $sql, $params);
        if ($stmt === false) {
            die(print_r(sqlsrv_errors(), true));
        }
        else{
            echo "<center>"."<main>"."<p1>"."訂單已送出，感謝下訂"."</p1>"."</main>"."</center>";
        }
    ?>
    <footer>
